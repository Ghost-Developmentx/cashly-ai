...
class IntentClassifier:
    ...
    def _generate_training_data(self) -> Tuple[List[str], List[str]]:
        ...
        realistic_queries = [
            ...
            ("Connect Bank Account", "bank_connection"),
            ("I want to add a new bank account", "bank_connection"),
            ("How can I send Invoices?", "payments_processing"),
            ("Can you accept payments?", "payments_processing"),
            ("Connect Stripe", "payment_processing"),
    ...
    def _classify_with_rules(self, query: str) -> Dict[str, any]:
        ...
        action_patterns = {
            "invoices": ["invoice", "bill", "payment", "reminder", "client"],
            "bank_connection": ["connect bank", "link bank", "bank account"],
            "payment_processing": [
                "accept payments",
                "process payments",
                "connect stripe",
